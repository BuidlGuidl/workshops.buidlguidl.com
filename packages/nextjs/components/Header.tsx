...
export const Header = () => (
  <>
    <Head>
      ...
      <meta property="twitter:image" content="https://workshops.buidlguidl.com/thumbnail.png" />
    </Head>
    <div className="sticky lg:static top-0 navbar bg-base-100 min-h-0 flex-shrink-0 justify-between z-20 p-4 items-start">
      <div className="flex-col items-start">
        ...
        <p className="m-0 text-secondary leading-5 opacity-50">BuidlGuidl Cohorts</p>
      </div>
